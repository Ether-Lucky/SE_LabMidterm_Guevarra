...
- **CI/CD Pipeline** – GitHub Actions automatically runs tests on every push to develop
...
- Automatically triggers on every push to the develop branch
...
See quality_analysis.md for a detailed discussion of:
